    ...
    loadingEl.innerHTML = `
      <div class="load-error">
        ...
        <ol class="err-steps">
          ...
          <li>Open Terminal on your computer, type <code>cd </code> (with a space), then drag the project folder into the Terminal window and press Enter. Then run <code>npx serve .</code> and open <a href="http://localhost:3000" target="_blank" rel="noopener">http://localhost:3000</a> in your browser. Keep Terminal open while using the app.</li>
        </ol>
      </div>`;
